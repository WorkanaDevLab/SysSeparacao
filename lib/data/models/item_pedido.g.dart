...
ItemPedido _$ItemPedidoFromJson(Map<String, dynamic> json) => ItemPedido(
      ...
      PROD_CODIGO1: json['PROD_CODIGO1'] as String?,
      PROD_CODIGO2: json['PROD_CODIGO2'] as String?,
      PROD_CODIGO3: json['PROD_CODIGO3'] as String?,
      PROD_CODIGO4: json['PROD_CODIGO4'] as String?,
...
Map<String, dynamic> _$ItemPedidoToJson(ItemPedido instance) =>
    <String, dynamic>{
      ...
      'PROD_CODIGO1': instance.PROD_CODIGO1,
      'PROD_CODIGO2': instance.PROD_CODIGO2,
      'PROD_CODIGO3': instance.PROD_CODIGO3,
      'PROD_CODIGO4': instance.PROD_CODIGO4,
      'PROD_NOME': instance.PROD_NOME,
      'PROD_ENDERECO': instance.PROD_ENDERECO,
      'SETR_NOME': instance.SETR_NOME,
      'ITPD_EDICAO': instance.ITPD_EDICAO,
    };
