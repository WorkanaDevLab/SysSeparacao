...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.success(success: $success)';
  }
...
abstract class Success<T> implements ApiResult<T> {
  factory Success(final T success) = _$SuccessImpl<T>;
...
abstract class Error<T> implements ApiResult<T> {
  factory Error(final T error) = _$ErrorImpl<T>;
